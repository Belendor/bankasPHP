...
<body>
    ...
    <div class="container">
        ...
        <div class="form">
            ...
            <div class="menu">
                <a href="/bankas/saskaitu-sarasas.php">Perziureti saskaitu sarasa <i class="text-icon icon-external-link"></i></a><br>
                <a href="/bankas/login.php?logout">Atsijungti <i class="icon-signout text-icon"></i> </a><br>
            </div>
